...
#include <vector.h>
	...
	TFile * input1 = new TFile ("p6mlm.root");
        input1->cd("");
        TTree *Outtree1 = (TTree*)input1->Get("tree");

	TFile * input2 = new TFile ("p6lo.root");
        input2->cd("");
        TTree *Outtree2 = (TTree*)input2->Get("tree");
 
	TFile * input3 = new TFile ("mg242p8mlm.root");
        input3->cd("");
        TTree *Outtree3 = (TTree*)input3->Get("t");

	TFile * input4 = new TFile ("mg267p8mlm.root");
        input4->cd("");
        TTree *Outtree4 = (TTree*)input4->Get("t");
       ...
       PTA2->Sumw2();
       TH1D *PTA3   = new TH1D("c"," ",20,0,200);
       PTA3->Sumw2();
       TH1D *PTA4   = new TH1D("d"," ",20,0,200);
       PTA4->Sumw2();
       double ptz1,ptz2,ptz3,ptz4;
     ...
     l1->SetBorderSize(1);
     l1->SetFillColor(0);
     l1->AddEntry(PTA1,"MG242+Pythia6 MLM");
     l1->AddEntry(PTA2,"MG242+Pythia6 LO");
     l1->AddEntry(PTA3,"MG242_LHE_Pythia8 MLM");
     l1->AddEntry(PTA4,"MG267_LHE_Pythia8 MLM");
