...
C     
C     Process: e+ e- > mu+ mu- WEIGHTED<=4 / z @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     
      ...
      REAL*8  pa1, pa2, pb1, pb2, m12, q12
C     
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
      ...
      ANS=ANS/DBLE(IDEN)
      Print *, "---------------"
      Print *, "ZQQQQ1", ANS*4.0
      q12=2d0*(P(0,3)*P(0,4)-P(1,3)*P(1,4)-P(2,3)*P(2,4)-P(3,3)*P(3,4))
      pa1=(P(0,1)*P(0,3)-P(1,1)*P(1,3)-P(2,1)*P(2,3)-P(3,1)*P(3,3))
      pa2=(P(0,1)*P(0,4)-P(1,1)*P(1,4)-P(2,1)*P(2,4)-P(3,1)*P(3,4))
      pb1=(P(0,2)*P(0,3)-P(1,2)*P(1,3)-P(2,2)*P(2,3)-P(3,2)*P(3,3))
      pb2=(P(0,2)*P(0,4)-P(1,2)*P(1,4)-P(2,2)*P(2,4)-P(3,2)*P(3,4))
      m12=32.d0*(pa1*pb2+pa2*pb1)/q12/q12*8.9937763771622652E-003
      Print *, "ZQQQQ2", m12, q12 
      Print *, "---------------"
